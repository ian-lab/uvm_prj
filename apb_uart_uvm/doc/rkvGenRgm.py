...
class GenRgm:
    ...
    def __init__(self):
        ...
        self._rgmItemList = []
        self._curRegName = ''
        self._uvmFileName = r'C:\Users\84308\Desktop\UVMshizhan\uvm_advanced_lab3\mcdf_rgm_pkg.sv'
...
if __name__ == '__main__' :
    ...
    def testGenUVMRgm():
        print('%s \n[testReadClockFile] started \n%s\n' % (40*'*', 40*'*'))
        gen = GenRgm()
        gen.readRgmFile(r'C:\Users\84308\Desktop\UVMshizhan\uvm_advanced_lab3\mcdf_regs_v2.csv')
        gen.genUVMFile()
        print('%s \n[testReadClockFile] PASSED \n%s\n' % (40*'*', 40*'*'))
    moduleTestList.append(testReadRgmFile)
